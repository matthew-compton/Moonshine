package com.ambergleam.moonshine.model;
...
public class WeatherProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            // "weather"
            case WEATHER: {
                retCursor = mWeatherDatabaseHelper.getReadableDatabase().query(
    ...
    public Uri insert(Uri uri, ContentValues values) {
        final SQLiteDatabase db = mWeatherDatabaseHelper.getWritableDatabase();
        final int match = sUriMatcher.match(uri);
        Uri returnUri;
    ...
    private Cursor getWeatherByLocationSetting(Uri uri, String[] projection, String sortOrder) {
        ...
        return sWeatherByLocationSettingQueryBuilder.query(mWeatherDatabaseHelper.getReadableDatabase(),
                projection,
                selection,
                selectionArgs,
                null,
